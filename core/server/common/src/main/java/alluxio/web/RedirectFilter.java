...
public class RedirectFilter implements Filter {
  ...
  private static final Pattern[] NO_REDIRECTION_PATH_PATTERNS =
      new Pattern[] {Pattern.compile("/metrics/json"), Pattern.compile("/metrics/prometheus")};

  /** primary selector. */
  private final PrimarySelector mPrimarySelector;

  /** Supplier to get primary master web port. */
  ...
  /**
   * 
   * @return current node is leader master node.
   */
  ...
  /**
   * 
   * @return the rpc address of the primary master.
